ВАЖНО! ГРАФИКИ СФОРМИРОВАННЫЕ ПРИ ПОМОЩИ БИБЛИОТЕКИ Plotly github не читает, точнее не видит их интерактивность, по этому файлы с графиками добавлены отдельно. 
